      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {(eyebrow || title || intro) && (
          <div className="max-w-3xl">
            ...
            {title && <h2 className="mt-4 font-display text-3xl md:text-5xl leading-tight text-navy-950">{title}</h2>}
    ...
    <section className="relative overflow-hidden bg-canvas border-b border-border">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 grid gap-10 md:grid-cols-5 items-center">
        <div className="md:col-span-3">
          {eyebrow && <span className="pill">{eyebrow}</span>}
          <h1 className="mt-5 font-display text-4xl md:text-6xl leading-[1.05] text-navy-950">{title}</h1>
